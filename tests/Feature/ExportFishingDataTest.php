...
class ExportFishingDataTest extends TestCase
{
    // Trait refresh database agar migration dijalankan
    use RefreshDatabase;

    public function test_user_can_export_data_fishing_data()
    {
        ...
        // 4. pengguna melakukan hit url untuk mengekspor data
        $this->post(route('dashboard.fishing-data.export'));
