...
class ExportStatistic7Test extends TestCase
{
    // Trait refresh database agar migration dijalankan
    use RefreshDatabase;

    public function test_user_can_export_data_statistic_7()
    {
        ...
        // 2. sebuah akting bahwa pengguna telah melakukan login sebelumnya dan mengakses halaman statistik 7
        ...
        $this->post('/dashboard/statistic/7/export?year=' . $year . '&type_fish_id=' . $type_fish->dtkn . '&species_fish_id=' . $species_fish->dtkn. '&month=' . $arrayMonth);

        // 4. berhasil melakukan pemanggilan data statistik 7
