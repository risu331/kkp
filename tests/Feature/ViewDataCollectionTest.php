...
class ViewDataCollectionTest extends TestCase
{
    // Trait refresh database agar migration dijalankan
    use RefreshDatabase;

    public function test_user_can_view_data_collection()
    {
        ...
        $response->assertViewIs('dashboard.fishing-data.data-collection.index');
    }

    public function test_user_cannot_view_data_collection()
    {
    ...
    public function test_user_can_get_data_data_collection()
    {
        // 1. generate 1 data pengguna dengan role admin
         $user = factory(User::class)->create([
            'role' => 'admin',
