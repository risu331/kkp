...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb"> 
            ...
            <li class="breadcrumb-item"><a href="{{ route('dashboard.fishing-data.data-collection.index') }}?id={{ $fishing_data->dtkn }}">Detail Pendataan Ikan</a></li>
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-title">Edit Pendataan Ikan Form</h6>
                                ...
                                <select name="species_fish_id" class="js-example-placeholder-single js-states form-control @error('species_fish_id') is-invalid @enderror" id="select-search-fish">
                                    ...
                                    <optgroup label="{{ $type_fish->type }}">
                                        @foreach($type_fish->species_fishs as $species_fish)
                                            @if(Request::input('species_fish_id') != null)
                                            ...
                                            @else
                                                <option value="{{ $species_fish->dtkn }}" {{ $data_collection->species_fish_id == $species_fish->id ? 'selected' : '' }}><i>{{ $species_fish->species }}</i>/{{ $species_fish->local }}/{{ $species_fish->general }}</option>
                                            @endif
                                        @endforeach
                                    </optgroup>
                                    @endforeach
                    ...
                    @php
                        $species = \App\Models\SpeciesFish::where('id', $data_collection->species_fish_id)->first();
                    @endphp
                    @if($species != null)
                        <form action="{{ route('dashboard.fishing-data.data-collection.update', $data_collection->dtkn) }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            @php
                            ...
                            @endphp
                            <input type="hidden" name="species_fish_id" value="{{ $species_fish_id ?? $data_collection->species_fish_id }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="amount_fish" class="form-control @error('amount_fish') is-invalid @enderror input-amount-fish" id="" placeholder="Jumlah Ekor" value="{{ old('amount_fish', $data_collection->amount_fish) }}" >
                                    @error('amount_fish')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="sl" class="form-control @error('sl') is-invalid @enderror" id="" placeholder="99.9 cm" value="{{ old('sl', $data_collection->sl) }}" >
                                    @error('sl')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="fl" class="form-control @error('fl') is-invalid @enderror" id="" placeholder="99.9 cm" value="{{ old('fl', $data_collection->fl) }}" >
                                    @error('fl')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="tl" class="form-control @error('tl') is-invalid @enderror" id="" placeholder="99.9 cm" value="{{ old('tl', $data_collection->tl) }}" >
                                    @error('tl')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="dw" class="form-control @error('dw') is-invalid @enderror" id="" placeholder="99.9 cm" value="{{ old('dw', $data_collection->dw) }}" >
                                    @error('dw')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="m" class="form-control @error('m') is-invalid @enderror" id="" placeholder="99.9 cm" value="{{ old('m', $data_collection->m) }}" >
                                    @error('m')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="p" class="form-control @error('p') is-invalid @enderror" id="" placeholder="99.9 cm" value="{{ old('p', $data_collection->p) }}" >
                                    @error('p')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="t" class="form-control @error('t') is-invalid @enderror" id="" placeholder="99.9 cm" value="{{ old('t', $data_collection->t) }}" >
                                    @error('t')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="mp" class="form-control @error('mp') is-invalid @enderror" id="" placeholder="99.9 cm" value="{{ old('mp', $data_collection->mp) }}" >
                                    @error('mp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <!--    <div class="col-sm-9">-->
                            <!--        <input type="number" name="pt" class="form-control @error('pt') is-invalid @enderror" id="" placeholder="99.9 cm" value="{{ old('pt', $data_collection->pt) }}" >-->
                            <!--        @error('pt')-->
                            <!--            <div class="invalid-feedback">{{ $message }}</div>-->
                            <!--        @enderror-->
                            <!--    </div>-->
                            ...
                            <!--    <div class="col-sm-9">-->
                            <!--        <input type="number" name="ps" class="form-control @error('ps') is-invalid @enderror" id="" placeholder="99.9 cm" value="{{ old('ps', $data_collection->ps) }}" >-->
                            <!--        @error('ps')-->
                            <!--            <div class="invalid-feedback">{{ $message }}</div>-->
                            <!--        @enderror-->
                            <!--    </div>-->
                            ...
                            <!--    <div class="col-sm-9">-->
                            <!--        <input type="number" name="lt" class="form-control @error('lt') is-invalid @enderror" id="" placeholder="99.9 cm" value="{{ old('lt', $data_collection->lt) }}" >-->
                            <!--        @error('lt')-->
                            <!--            <div class="invalid-feedback">{{ $message }}</div>-->
                            <!--        @enderror-->
                            <!--    </div>-->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="weight" class="form-control @error('weight') is-invalid @enderror input-weight" id="" placeholder="99.9 Kg" value="{{ old('weight', $data_collection->weight) }}" >
                                    @error('weight')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                <label for="" class="col-sm-3 col-form-label">Jenis Kelamin <span class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                    <select name="gender" class="form-control input-gender">
                                        <option value="j" {{ $data_collection->gender == 'j' ? 'selected' : '' }}>Jantan</option>
                                        <option value="b" {{ $data_collection->gender == 'b' ? 'selected' : '' }}>Betina</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="clasp_length" class="form-control" placeholder="0 cm" value="{{ old('clasp_length', $data_collection->clasp_length) }}">
                                </div>
                            </div>
                            <div class="row mb-3 input-jantan d-none">
                                ...
                                <div class="col-sm-9">
                                    <select name="gonad" class="form-control">
                                        ...
                                        <option value="1" {{ $data_collection->gonad == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ $data_collection->gonad == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ $data_collection->gonad == '3' ? 'selected' : '' }}>3</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-3 input-betina d-none">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="amount_child" class="form-control" placeholder="0 ekor" value="{{ old('amount_child', $data_collection->amount_child) }}">
                                </div>
                            </div>
                            <div class="row mb-3 input-betina d-none">
                                <label for="" class="col-sm-3 col-form-label">Berat Anakan</label>
                                <div class="col-sm-9">
                                    <input type="number" name="weight_child" class="form-control" placeholder="99.9 Kg" value="{{ old('weight_child', $data_collection->weight_child) }}">
                                </div>
                            </div>
                            <div class="row mb-3 input-betina d-none">
                                <label for="" class="col-sm-3 col-form-label">Ukuran Anakan Min</label>
                                <div class="col-sm-9">
                                    <input type="text" name="length_min_child" class="form-control" placeholder="0 cm" value="{{ old('length_min_child', $data_collection->length_min_child) }}">
                                </div>
                            </div>
                            <div class="row mb-3 input-betina d-none">
                                <label for="" class="col-sm-3 col-form-label">Ukuran Anakan Max </label>
                                <div class="col-sm-9">
                                    <input type="text" name="length_max_child" class="form-control" placeholder="0 cm" value="{{ old('length_max_child', $data_collection->length_max_child) }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="" class="col-sm-3 col-form-label">Harga Ekonomi per 1 Kg </label>
                                <div class="col-sm-9">
                                    <input type="number" name="economy_price" class="form-control input-economy-price" placeholder="1.000" value="{{ old('economy_price', $data_collection->economy_price) }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="" class="col-sm-3 col-form-label">Total Harga Ekonomi</label>
                                <div class="col-sm-9">
                                    <input type="number" name="total_economy_price" class="form-control input-total-economy-price" placeholder="Berat x Harga" value="{{ old('total_economy_price', $data_collection->total_economy_price) }}" readonly>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="" class="col-sm-3 col-form-label">Keterangan </label>
                                <div class="col-sm-9">
                                    <textarea name="description" class="form-control" placeholder="Keterangan">{{ old('description', $data_collection->description) }}</textarea>
                                </div>
                            </div>
                            @foreach($type_fish_pictures as $key => $picture)
                                @php
                                    $image = App\Models\DataImage::where('data_collection_id', $data_collection->id)->where('title', $picture->title)->first();
                                @endphp
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-center">
                                        <div class="p-3 mb-1" style="border: 1px dashed black;">
                                            <img src="{{ $image->image ?? 'https://static.thenounproject.com/png/2390797-200.png' }}" width="100" id="results-{{ $picture->id }}" data-enlargable>
                                        </div>
                                        <br>
                                        ...
                                        <label class="btn btn-secondary">
                                            <i class="link-icon" data-feather="camera"></i> Buka Kamera
