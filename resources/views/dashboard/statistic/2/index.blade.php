...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Statistik Data Jenis Ikan</li>
    </ol>
</nav>
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            @if(Request::input('year') != null && Request::input('type_fish_id') != null)
                <div class="card-header">
                    <!--<button type="button" class="btn btn-success btn-export" style="float: right;">Export</button>-->
                    <a href='{{ route("dashboard.statistic.export.2") }}?branch_id={{ Request::input("branch_id") }}&year={{ Request::input("year") }}&month={{ $month }}' class="btn btn-success" style="float: right;">Export</a>
                </div>
            @endif
            <div class="card-body">
                <h6 class="card-title">Statistik Data Ikan</h6>
                <p class="text-muted mb-3">Menampilkan data jenis ikan yang didaratkan per bulannya</p>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label>Tahun:</label>
                    <div class="form-control" readonly>{{ Request::input('year') ?? '' }}</div>
                </div>
                <div class="mb-3">
                    <label>Bulan:</label>
...
// delete events
    $(document).on("click", ".btn-export", function()
    {
        ...
        $("#btn-submit-export").on('click', function(){
            ...
            var url = '{{ route("dashboard.statistic.export.2") }}?branch_id={{ Request::input("branch_id") }}&year={{ Request::input("year") }}-'+ month +'&species_fish_id=' + val;
