...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Statistik Komposisi Hasil Tangkap Ikan</li>
    </ol>
</nav>
        ...
        <div class="row">
            @if(Auth::user()->role != 'superadmin')
                ...
                <div class="col-6 col-md-3 mb-3">
                    ...
                    <select name="landing_site_id" class="js-example-placeholder-single js-states form-control" id="select-search-landing-site" required>
                        <option></option>
                        @foreach($landing_sites as $landing_site)
                            <option value="{{ $landing_site->dtkn }}" {{ $landing_site->dtkn == Request::input('landing_site_id') ? 'selected' : '' }}>{{ $landing_site->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-6 col-md-2 mb-3">
                    ...
                    <select name="category" class="js-example-placeholder-single js-states form-control" required>
                        ...
                        <option value="weight_fish" {{ 'weight_fish' == Request::input('category') ? 'selected' : '' }}>Berat</option>
                    </select>
                </div>
                <div class="col-6 col-md-2 mb-3">
                    <label>&nbsp;</label>
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            @if(Request::input('landing_site_id') != null && Request::input('type_fish_id') != null)
            <div class="card-header">
                <!--<button type="button" class="btn btn-success btn-export" style="float: right;">Export</button>-->
                <a href='{{ route("dashboard.statistic.export.1") }}?branch_id={{ Request::input("branch_id") }}&start_date={{ $start_date }}&end_date={{ $end_date }}&category={{ Request::input("category") }}&landing_site_id={{ Request::input("landing_site_id") }}' class="btn btn-success" style="float: right;">Export</a>
            </div>
            @endif
            <div class="card-body">
                <h6 class="card-title">Statistik Data Ikan</h6>
                <p class="text-muted mb-3">Menampilkan data ikan yang didaratkan berdasarkan lokasi pendaratan dan jenis ikan</p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                @php
                    ...
                    $landing_site = \App\Models\LandingSite::where('dtkn', Request::input('landing_site_id'))->first();
                @endphp
                @if(Auth::user()->role == 'superadmin')
                    <div class="mb-3">
                        <label>Wilayah Kerja:</label>
                ...
                <div class="mb-3">
                    <label>Lokasi Pendaratan:</label>
                    <div class="form-control" readonly>{{ $landing_site->name ?? '' }}</div>
                </div>
...
// delete events
    $(document).on("click", ".btn-export", function()
    {
        ...
        $("#btn-submit-export").on('click', function(){
            ...
            var url = '{{ route("dashboard.statistic.export.1") }}?branch_id={{ Request::input("branch_id") }}&start_date={{ $start_date }}&end_date={{ $end_date }}&category={{ Request::input("category") }}&landing_site_id={{ Request::input("landing_site_id") }}&species_fish_id=' + val;
