...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Statistik Frekuensi Panjang</li>
    </ol>
</nav>
        ...
        <div class="row">
            ...
            @if(Auth::user()->role != 'superadmin')
                ...
                <div class="col-6 col-md-3 mb-3">
                    ...
                    <select name="species_fish_id" class="js-example-placeholder-single js-states form-control" id="select-search-species-fish" required>
        ...
        <div class="card">
            @if(Request::input('type_fish_id') != null)
                <div class="card-header">
                    ...
                    <a href='{{ route("dashboard.statistic.export.7") }}?branch_id={{ Request::input("branch_id") }}&month={{ $month }}&species_fish_id={{ $species_fish_id }}&year={{ Request::input("year") }}&type_fish_id={{ Request::input("type_fish_id") }}' class="btn btn-success" style="float: right;">Export</a>
                </div>
            @endif
            <div class="card-body">
                <h6 class="card-title">Statistik Data Ikan</h6>
                <p class="text-muted mb-3">Menampilkan frekuensi panjang data individu</p>
...
new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
          label: @json($statistic['labels'])[0],
          backgroundColor: 'green',
          data: @json($statistic['born'])
        }, {
          label: @json($statistic['labels'])[1],
          backgroundColor: 'blue',
          data: @json($statistic['mature_male'])
        }, {
          label: @json($statistic['labels'])[2],
          backgroundColor: 'pink',
          data: @json($statistic['mature_female'])
        }, {
          label: @json($statistic['labels'])[3],
          backgroundColor: 'red',
          data: @json($statistic['mega_spawner'])
        }, {
          label: @json($statistic['labels'])[4],
          backgroundColor: 'grey',
          data: @json($statistic['uncategory'])
        }]
     },
});
</script>
