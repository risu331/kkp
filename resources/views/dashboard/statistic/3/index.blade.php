...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Statistik Status Appendiks</li>
    </ol>
</nav>
        ...
        <div class="card">
            @if(Request::input('type_fish_id') != null)
                <div class="card-header">
                    ...
                    <a href='{{ route("dashboard.statistic.export.3") }}?branch_id={{ Request::input("branch_id") }}&start_date={{ $start_date }}&end_date={{ $end_date }}$category={{ Request::input("category") }}' class="btn btn-success" style="float: right;">Export</a>
                </div>
            @endif
            <div class="card-body">
                <h6 class="card-title">Statistik Data Ikan</h6>
                <p class="text-muted mb-3">Menampilkan data komposisi hasil tangkapan berdasarkan status appendiks dan non-appendiks</p>
...
// delete events
    $(document).on("click", ".btn-export", function()
    {
        ...
        $("#btn-submit-export").on('click', function(){
            ...
            var url = '{{ route("dashboard.statistic.export.3") }}?branch_id={{ Request::input("branch_id") }}&month={{ Request::input("month") }}&species_fish_id=' + val;
...
new Chart(ctx, {
    type: 'pie',
    data: {
        labels: ['Appendiks', 'Non-appendiks'],
        datasets: [{
            label: newLabel,
            data: @json($statistic),
