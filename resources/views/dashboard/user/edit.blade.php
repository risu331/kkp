        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-title">Edit User Form</h6>

                    <form action="{{ route('dashboard.user.update', $user->id) }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select name="role" class="form-control @error('role') is-invalid @enderror" id="select1" required>
                                    ...
                                    @endif
                                    <option value="enumerator" {{ $user->role == 'enumerator' ? 'selected' : '' }}>Enumerator</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" id="exampleInputEmail2" placeholder="********">
