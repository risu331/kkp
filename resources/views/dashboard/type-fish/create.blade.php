...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tambah Jenis Ikan</li>
        </ol>
    </nav>
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-title">Tambah Jenis Ikan Form</h6>

                    <form action="{{ route('dashboard.type-fish.store') }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="color" name="icon" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="input2" class="col-sm-3 col-form-label">Jenis <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" name="type" class="form-control @error('type') is-invalid @enderror" id="input2" placeholder="Jenis Ikan" value="{{ old('type') }}" required>
                                @error('type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
